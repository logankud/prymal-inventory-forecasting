...
# Else, if there are invalid records, send an alert
    ...
    email_body = f"""Invalid data was generated by this pipeline for {invalid_data['sku_name'].unique().tolist()}.  No data will be written to S3 for this pipeline run.  Please check logs for details"""
